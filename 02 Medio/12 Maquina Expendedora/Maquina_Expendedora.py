...
monedas_recibidas = input("Ingrese las monedas separadas por comas (ejemplo: 100,50,10): ")
monedas_recibidas = [int(moneda) for moneda in monedas_recibidas.split(",")]
seleccion_producto = int(input("Seleccione el número del producto (1-3): "))
